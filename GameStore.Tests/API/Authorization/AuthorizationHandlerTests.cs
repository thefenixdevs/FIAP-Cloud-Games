...
{
    [Fact]
    public async Task ConfirmedAdminHandler_ShouldSucceed_WhenUserIsConfirmedAdmin()
    {
        ...
        var claims = new[]
        {
            ...
            new Claim("AccountStatus", "Confirmed")
        };
    ...
    [Fact]
    public async Task ConfirmedCommonUserHandler_ShouldSucceed_WhenUserIsConfirmedCommonUser()
    {
    ...
    [Fact]
    public async Task ConfirmedCommonUserHandler_ShouldSucceed_WhenUserIsConfirmedAdmin()
    {
        var handler = new ConfirmedCommonUserHandler();
        var requirement = new ConfirmedCommonUserRequirement();
